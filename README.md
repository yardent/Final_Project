...
לאחר שהרצנו את התוכנה שבנינו לבדיקת אמינות ואיכות התוצאות, גילינו כי קיבלנו 10% משפטים נכונים.
זאת לאחר שקיבלנו תוצאות פחות טובות וביצענו שינויים בהתאם על מנת לעזור למודל שלנו לחזות בצורה נכונה יותר את המשפטים. חלק מהפעולות שביצענו כללו:

• הורדת סימני פיסוק

• הורדת סיומת של שורת (/n)

ניתן לראות מהקובץ result כי אכן לא מעט משפטים יצאו דומים ובלי תוכנות מיוחדות ניתן לשים לב לדמיון בין שני קבצי הטקסט.

ניתן לבצע עוד שינויים בפרויקט על מנת לשפר את התוצאות:

1. תיקון שגיאות כתיב. להשוות מילים מהטקסט למילים מהמילון האנגלי.

2. לבדוק עם או בלי סימני פיסוק

3. הפרדה לפי תחביר- כלומר, הפרדה של פועל, שם עצם, שם תואר וכו'

4. מסמך קלט ארוך יותר.

5. השתמשנו במילים השכיחות ביותר. שמרנו 2000 מילים, ניתן לשנות את המספר הזה ולבדוק האם זה עוזר

6.  עם ובלי /n/r. 

אם היינו ממשיכים את הפרויקט היינו מנסים את השינויים הנ"ל, אך עקב חוסר זמן נאלצנו לוותר עליהם.

פרויקט זה או פרויקטים דומים, יכולים לעזור במגוון תחומים בחיים שלנו,

• לייצר מאמרים.

• לבדוק העתקות של מסמכים.
